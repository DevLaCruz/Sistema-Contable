                ...
                <div class="table-data">
                    <div class="formulinp">
                        ...
                        <form action="Controlador" method="post">
                            ...
                            <div class="form-control">
                                <label for="text">Tipo de Cambio</label>
                                <input type="text" name="txtTipo_cambio" placeholder="Tipo de Cambio">
                            </div>
                            ...
                            if(msj!=null)
                                out.print(msj);
                            %>
                            <input type="hidden" name="URL" value="agregar_tipooperacion">
