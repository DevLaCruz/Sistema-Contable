...
<html>
    ...
    <body>
                    ...
                    <div class="formulinp">
                        ...
                        <form action="Controlador" method="post">
                            <div class="form-control">
                                ...
                                <input type="text" name="txtNumero" placeholder="Número" maxlength="<%=Usuario.getDigitos()%>">
                            </div>
                            <div class="form-control">
                ...
                <div class="contenedor-modal">
                    <div class="modal">
                        ...
                        <form id="formModal">
                            <div class="form-control">
                                <label for="text">Número</label>
                                <input type="text" name="txtNumeroM" id="numeroM" placeholder="Número" readonly>
                            </div>
                            <div class="form-control">
                                <label for="text">Nombre</label>
                            ...
                            <div class="form-control">
                                <label for="text">Moneda</label>
                                <select name="txtMonedaM" id="monedaM">
                                    <option selected></option>
                                    <option value="Soles">Soles</option>
                                    <option value="Dólares">Dólares</option>
                                </select>
        ...
        <script src="js/PlanContable.js" type="text/javascript"></script>
