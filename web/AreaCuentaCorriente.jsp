                ...
                <div class="table-data">
                    <div class="formulinp">
                        ...
                        <form action="Controlador" method="post">
                            ...
                            <div class="form-control">
                                <label for="text">Denominacion</label>
                                <input type="text" name="txtDenominacion" placeholder="Denominacion">
                            </div>
                            <div class="form-control">
                                <label for="text">Pais</label>
                                <input type="text" name="txtPais" placeholder="Pais">
                            </div>
                           <div class="form-control">
                            ...
                            <div class="form-control">
                                <label for="text">ID Identificacion</label>
                                <input type="text" name="txtidtipo" placeholder="Identificacion">
                            </div>
                            ...
                            if(msj!=null)
                                out.print(msj);
                            %>
                            <input type="hidden" name="URL" value="agregar_cuentacorriente">
