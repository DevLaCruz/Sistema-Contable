                    ...
                    <div class="formulinp">
                        ...
                        <form action="Controlador" method="post">
                            <div class="form-control">
                                <label for="text">Cuenta Origen</label>
                                <input type="text" name="txtCuenta_origen" placeholder="Cuenta Origen">
                            </div>
                            <div class="form-control">
                                <label for="text">Cuenta Cargo</label>
                                <input type="text" name="txtCuenta_cargo" placeholder="Cuenta Cargo">
                            </div>
                            <div class="form-control">
                                <label for="text">Cuenta Abono</label>
                                <input type="text" name="txtCuenta_abono" placeholder="Cuenta Abono">
                            </div>
                            ...
                            if(msj!=null)
                                out.print(msj);
                            %>
                            <input type="hidden" name="URL" value="agregar_destinocompra">
